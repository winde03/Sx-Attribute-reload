...
public class ItemUtil {
    ...
    public ItemStack setAttackSpeed(ItemStack item, double... speed) {
        ItemStack im=item;
        if (im != null && !im.getType().name().equals("AIR")) {
            try {
                Object nmsItem = xAsNMSCopay.invoke(xCraftItemStack, setNBT(im, "Clear", "yes" + Config.isDamageGauges()));
                ...
                xSet.invoke(attackSpeed, "Amount", xNewNBTTagDouble.newInstance(getAttackSpeed(im, speed)));
